    ...
    <div class="cal-footer-newsletter">
      <div class="cal-container cal-footer-newsletter-inner">
        <div class="cal-footer-newsletter-text">
          ...
          <p>Exclusive offers, new products and Exclusive offers, new products and parenting tips.</p>
        </div>
    ...
    <div class="cal-footer-main">
      <div class="cal-container cal-footer-grid">
        ...
        <div class="cal-footer-col cal-footer-brand">
          <div class="cal-footer-logo">BAMBELLE</div>
          <p class="cal-footer-tag">Soft, supportive carriers that<br>keep your little one close.</p>
        ...
        <div class="cal-footer-col">
          <h4>Shop</h4>
          <ul>
            <li><a href="<?php echo esc_url( home_url( '/product/toddler-sling-carrier/' ) ); ?>">Bambelle Sling Carrier</a></li>
        ...
        <div class="cal-footer-col">
          ...
          <div class="cal-footer-contact">
            <p><strong>Support:</strong><br><a href="mailto:info@info@bambelle.si">info@info@bambelle.si</a></p>
          </div>
        </div>
    ...
    <div class="cal-footer-bottom">
      <div class="cal-container cal-footer-bottom-inner">
        <div class="cal-footer-copy">
          © <?php echo date('Y'); ?> Bambelle. All rights reserved.
        </div>
