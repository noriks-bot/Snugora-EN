...
<body <?php body_class( 'bambelle-body' ); ?>>

<?php wp_body_open(); ?>

<div id="page" class="bambelle-site">
    ...
    <div class="cal-header-inner">
      ...
      <div class="cal-header-left">
        ...
        <nav class="cal-nav-desktop" aria-label="Main menu">
          ...
          <a href="<?php echo esc_url( home_url( '/product/toddler-sling-carrier/' ) ); ?>">Bambelle Sling Carrier</a>
        </nav>
      </div>

      <a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="cal-logo" aria-label="Bambelle">
        <span class="cal-logo-text">BAMBELLE</span>
      </a>
