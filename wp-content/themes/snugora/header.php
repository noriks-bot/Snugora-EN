...
<body <?php body_class( 'snugora-body' ); ?>>

<?php wp_body_open(); ?>

<div id="page" class="snugora-site">
  ...
  <header class="cal-header" role="banner">
    <div class="cal-header-inner">
      ...
      <a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="cal-logo" aria-label="Snugora">
        <span class="cal-logo-text">SNUGORA</span>
      </a>
